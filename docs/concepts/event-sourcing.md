...
Node B replicates the log and can forward writes to the leader
Node C replicates the log and serves local reads from Pebble
...
- Callers can hit any node; follower writes are forwarded internally
