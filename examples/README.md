...
# Or start only the engine nodes and specific examples
docker compose up argyll-engine-1 argyll-engine-2 argyll-engine-3 user-resolver inventory-resolver
```
