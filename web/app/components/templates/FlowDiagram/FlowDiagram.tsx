...
import OverviewStepDiagram from "@/app/components/templates/OverviewStepDiagram";
import LiveFlowStepDiagram from "@/app/components/templates/LiveFlowStepDiagram";
...
const FlowDiagramContent: React.FC = () => {
  ...
  const { goalSteps, toggleGoalStep, setGoalSteps, clearPreviewPlan } = useUI();
  ...
  }, [isFlowMode, clearPreviewPlan, setGoalSteps]);
          ...
          >
            ...
            >
              {isFlowMode ? (
                ...
                <OverviewStepDiagram steps={steps || []} />
              )}
            </DiagramSelectionProvider>
          </ErrorBoundary>
        </div>
